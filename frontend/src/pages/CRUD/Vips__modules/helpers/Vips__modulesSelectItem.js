...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__modules/autocomplete`, { params });
  return response.data;
}

const Vips__modulesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__modules.hasPermissionToCreate,
});

export default connect(select)(Vips__modulesSelectItem);
