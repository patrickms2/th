...
const Vips__appointment_recurrenceSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__appointment_recurrence.hasPermissionToCreate,
});

export default connect(select)(Vips__appointment_recurrenceSelectItem);
