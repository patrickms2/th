...
import Vips__teamsFormView from 'pages/CRUD/Vips__teams/form/Vips__teamsFormView';
import { push } from 'connected-react-router';
import actions from 'actions/vips__teams/vips__teamsFormActions';
import { connect } from 'react-redux';

const Vips__teamsFormPageView = (props) => {
...
export default connect(mapStateToProps)(Vips__teamsFormPageView);
