...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__departments_roles/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__departments_rolesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__departments_roles.hasPermissionToCreate,
});

export default connect(select)(Vips__departments_rolesSelectItem);
