...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__leave_attachments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__leave_attachmentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__leave_attachments.hasPermissionToCreate,
});

export default connect(select)(Vips__leave_attachmentsSelectItem);
