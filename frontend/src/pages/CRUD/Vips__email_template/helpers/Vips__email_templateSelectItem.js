...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__email_template/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__email_templateSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__email_template.hasPermissionToCreate,
});

export default connect(select)(Vips__email_templateSelectItem);
