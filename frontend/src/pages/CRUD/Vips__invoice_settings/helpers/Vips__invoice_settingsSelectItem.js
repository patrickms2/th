...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__invoice_settings/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__invoice_settingsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__invoice_settings.hasPermissionToCreate,
});

export default connect(select)(Vips__invoice_settingsSelectItem);
