...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__project_comments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__project_commentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__project_comments.hasPermissionToCreate,
});

export default connect(select)(Vips__project_commentsSelectItem);
