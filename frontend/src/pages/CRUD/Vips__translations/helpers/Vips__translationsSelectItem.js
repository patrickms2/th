...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__translations/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__translationsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__translations.hasPermissionToCreate,
});

export default connect(select)(Vips__translationsSelectItem);
