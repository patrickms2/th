...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__user_settings/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__user_settingsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__user_settings.hasPermissionToCreate,
});

export default connect(select)(Vips__user_settingsSelectItem);
