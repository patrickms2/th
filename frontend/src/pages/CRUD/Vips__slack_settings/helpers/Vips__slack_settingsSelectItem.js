...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__slack_settings/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__slack_settingsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__slack_settings.hasPermissionToCreate,
});

export default connect(select)(Vips__slack_settingsSelectItem);
