...
const Vips__slack_settingsForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(vips__slack_settingsFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(
      vips__slack_settingsFields,
      values || {},
    );
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Vips__slack_settings' : 'Add Vips__slack_settings';
  };
            ...
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <InputFormItem
                  ...
                  schema={vips__slack_settingsFields}
                  autoFocus
                />
              </Grid>
