...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__user_role_department/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__user_role_departmentSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__user_role_department.hasPermissionToCreate,
});

export default connect(select)(Vips__user_role_departmentSelectItem);
