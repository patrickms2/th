...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__task_comments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__task_commentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__task_comments.hasPermissionToCreate,
});

export default connect(select)(Vips__task_commentsSelectItem);
