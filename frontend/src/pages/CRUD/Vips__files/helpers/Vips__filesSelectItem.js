...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__files/autocomplete`, { params });
  return response.data;
}

const Vips__filesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__files.hasPermissionToCreate,
});

export default connect(select)(Vips__filesSelectItem);
