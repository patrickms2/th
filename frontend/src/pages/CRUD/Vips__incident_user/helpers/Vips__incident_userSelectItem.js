...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__incident_user/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__incident_userSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__incident_user.hasPermissionToCreate,
});

export default connect(select)(Vips__incident_userSelectItem);
