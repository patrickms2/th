...
import Vips__tasksFormView from 'pages/CRUD/Vips__tasks/form/Vips__tasksFormView';
import { push } from 'connected-react-router';
import actions from 'actions/vips__tasks/vips__tasksFormActions';
import { connect } from 'react-redux';

const Vips__tasksFormPageView = (props) => {
...
export default connect(mapStateToProps)(Vips__tasksFormPageView);
