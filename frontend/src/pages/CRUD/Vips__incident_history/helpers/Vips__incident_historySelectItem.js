...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__incident_history/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__incident_historySelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__incident_history.hasPermissionToCreate,
});

export default connect(select)(Vips__incident_historySelectItem);
