...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__department_role_menu/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__department_role_menuSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__department_role_menu.hasPermissionToCreate,
});

export default connect(select)(Vips__department_role_menuSelectItem);
