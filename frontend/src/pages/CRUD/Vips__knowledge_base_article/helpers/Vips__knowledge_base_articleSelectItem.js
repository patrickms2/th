...
const Vips__knowledge_base_articleSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__knowledge_base_article.hasPermissionToCreate,
});

export default connect(select)(Vips__knowledge_base_articleSelectItem);
