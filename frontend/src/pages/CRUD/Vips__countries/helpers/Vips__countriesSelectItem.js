...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__countries/autocomplete`, { params });
  return response.data;
}

const Vips__countriesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__countries.hasPermissionToCreate,
});

export default connect(select)(Vips__countriesSelectItem);
