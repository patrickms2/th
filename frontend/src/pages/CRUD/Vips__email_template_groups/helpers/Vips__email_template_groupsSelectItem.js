...
const Vips__email_template_groupsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__email_template_groups.hasPermissionToCreate,
});

export default connect(select)(Vips__email_template_groupsSelectItem);
