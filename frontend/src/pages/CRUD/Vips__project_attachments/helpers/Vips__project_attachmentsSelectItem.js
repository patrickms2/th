...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__project_attachments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__project_attachmentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__project_attachments.hasPermissionToCreate,
});

export default connect(select)(Vips__project_attachmentsSelectItem);
