...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__invoice_items/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__invoice_itemsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__invoice_items.hasPermissionToCreate,
});

export default connect(select)(Vips__invoice_itemsSelectItem);
