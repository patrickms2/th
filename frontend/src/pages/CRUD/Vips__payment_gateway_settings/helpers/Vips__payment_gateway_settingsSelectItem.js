...
const Vips__payment_gateway_settingsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__payment_gateway_settings.hasPermissionToCreate,
});

export default connect(select)(Vips__payment_gateway_settingsSelectItem);
