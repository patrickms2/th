...
import Vips__payment_gateway_settingsFormView from 'pages/CRUD/Vips__payment_gateway_settings/form/Vips__payment_gateway_settingsFormView';
import { push } from 'connected-react-router';
import actions from 'actions/vips__payment_gateway_settings/vips__payment_gateway_settingsFormActions';
import { connect } from 'react-redux';

const Vips__payment_gateway_settingsFormPageView = (props) => {
  ...
  return (
    <React.Fragment>
      {dispatched && (
        <Vips__payment_gateway_settingsFormView
...
export default connect(mapStateToProps)(
  Vips__payment_gateway_settingsFormPageView,
);
