...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__estimate_item_taxes/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__estimate_item_taxesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__estimate_item_taxes.hasPermissionToCreate,
});

export default connect(select)(Vips__estimate_item_taxesSelectItem);
