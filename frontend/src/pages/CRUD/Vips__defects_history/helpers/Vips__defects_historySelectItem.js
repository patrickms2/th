...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__defects_history/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__defects_historySelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__defects_history.hasPermissionToCreate,
});

export default connect(select)(Vips__defects_historySelectItem);
