...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__incident_attachments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__incident_attachmentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__incident_attachments.hasPermissionToCreate,
});

export default connect(select)(Vips__incident_attachmentsSelectItem);
