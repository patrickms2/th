...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__payment_methods/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__payment_methodsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__payment_methods.hasPermissionToCreate,
});

export default connect(select)(Vips__payment_methodsSelectItem);
