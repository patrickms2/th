...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__project_sprints/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__project_sprintsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__project_sprints.hasPermissionToCreate,
});

export default connect(select)(Vips__project_sprintsSelectItem);
