...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__task_attachments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__task_attachmentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__task_attachments.hasPermissionToCreate,
});

export default connect(select)(Vips__task_attachmentsSelectItem);
