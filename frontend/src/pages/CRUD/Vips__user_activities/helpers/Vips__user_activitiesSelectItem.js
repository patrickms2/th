...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__user_activities/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__user_activitiesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__user_activities.hasPermissionToCreate,
});

export default connect(select)(Vips__user_activitiesSelectItem);
