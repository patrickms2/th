...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__meeting_members/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__meeting_membersSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__meeting_members.hasPermissionToCreate,
});

export default connect(select)(Vips__meeting_membersSelectItem);
