...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__defect_attachments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__defect_attachmentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__defect_attachments.hasPermissionToCreate,
});

export default connect(select)(Vips__defect_attachmentsSelectItem);
