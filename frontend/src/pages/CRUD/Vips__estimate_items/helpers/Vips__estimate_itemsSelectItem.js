...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__estimate_items/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__estimate_itemsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__estimate_items.hasPermissionToCreate,
});

export default connect(select)(Vips__estimate_itemsSelectItem);
