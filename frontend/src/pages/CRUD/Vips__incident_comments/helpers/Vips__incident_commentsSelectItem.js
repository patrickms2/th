...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__incident_comments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__incident_commentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__incident_comments.hasPermissionToCreate,
});

export default connect(select)(Vips__incident_commentsSelectItem);
