...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__estimate_settings/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__estimate_settingsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__estimate_settings.hasPermissionToCreate,
});

export default connect(select)(Vips__estimate_settingsSelectItem);
