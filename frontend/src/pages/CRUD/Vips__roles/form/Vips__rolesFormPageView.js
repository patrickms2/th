...
import Vips__rolesFormView from 'pages/CRUD/Vips__roles/form/Vips__rolesFormView';
import { push } from 'connected-react-router';
import actions from 'actions/vips__roles/vips__rolesFormActions';
import { connect } from 'react-redux';

const Vips__rolesFormPageView = (props) => {
...
export default connect(mapStateToProps)(Vips__rolesFormPageView);
