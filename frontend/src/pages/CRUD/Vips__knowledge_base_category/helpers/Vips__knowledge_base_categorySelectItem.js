...
const Vips__knowledge_base_categorySelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__knowledge_base_category.hasPermissionToCreate,
});

export default connect(select)(Vips__knowledge_base_categorySelectItem);
