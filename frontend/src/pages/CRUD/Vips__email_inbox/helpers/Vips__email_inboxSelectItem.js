...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__email_inbox/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__email_inboxSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__email_inbox.hasPermissionToCreate,
});

export default connect(select)(Vips__email_inboxSelectItem);
