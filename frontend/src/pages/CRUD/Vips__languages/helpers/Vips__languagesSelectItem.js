...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__languages/autocomplete`, { params });
  return response.data;
}

const Vips__languagesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__languages.hasPermissionToCreate,
});

export default connect(select)(Vips__languagesSelectItem);
