...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__notifications/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__notificationsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__notifications.hasPermissionToCreate,
});

export default connect(select)(Vips__notificationsSelectItem);
