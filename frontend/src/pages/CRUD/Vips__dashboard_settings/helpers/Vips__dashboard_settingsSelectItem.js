...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__dashboard_settings/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__dashboard_settingsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__dashboard_settings.hasPermissionToCreate,
});

export default connect(select)(Vips__dashboard_settingsSelectItem);
