...
const Vips__email_inbox_attachmentSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__email_inbox_attachment.hasPermissionToCreate,
});

export default connect(select)(Vips__email_inbox_attachmentSelectItem);
