...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__announcements/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__announcementsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__announcements.hasPermissionToCreate,
});

export default connect(select)(Vips__announcementsSelectItem);
