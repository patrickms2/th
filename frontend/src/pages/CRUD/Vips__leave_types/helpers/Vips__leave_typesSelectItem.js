...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__leave_types/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__leave_typesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__leave_types.hasPermissionToCreate,
});

export default connect(select)(Vips__leave_typesSelectItem);
