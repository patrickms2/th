...
const Vips__project_sprint_membersSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate:
    state.vips__project_sprint_members.hasPermissionToCreate,
});

export default connect(select)(Vips__project_sprint_membersSelectItem);
