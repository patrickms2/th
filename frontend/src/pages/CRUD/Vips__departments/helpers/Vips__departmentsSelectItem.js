...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__departments/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__departmentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__departments.hasPermissionToCreate,
});

export default connect(select)(Vips__departmentsSelectItem);
