...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__custom_fields/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__custom_fieldsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__custom_fields.hasPermissionToCreate,
});

export default connect(select)(Vips__custom_fieldsSelectItem);
