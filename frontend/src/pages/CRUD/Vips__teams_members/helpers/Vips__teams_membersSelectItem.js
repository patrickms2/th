...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/vips__teams_members/autocomplete`, {
    params,
  });
  return response.data;
}

const Vips__teams_membersSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.vips__teams_members.hasPermissionToCreate,
});

export default connect(select)(Vips__teams_membersSelectItem);
